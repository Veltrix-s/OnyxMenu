...
public sealed class NocturneSnow : MonoBehaviour
{
    ...
    public void Update()
    {
        ...
        for (int i = 0; i < _live.Count; i++)
        {
            ...
            p.y -= f.Fall * dt;
            if (f.Drift > 0f)
                p.x += Mathf.Sin(t * f.Spin + f.Phase) * f.Drift * dt;
    ...
    private static Color Leaf()
    {
        ...
        {
            case 0:
                return new Color(0.85f, 0.42f, 0.12f, 0.95f);
            case 1:
                return new Color(0.72f, 0.20f, 0.12f, 0.95f);
            case 2:
                return new Color(0.92f, 0.68f, 0.18f, 0.95f);
            default:
                return new Color(0.55f, 0.35f, 0.13f, 0.95f);
        }
    }
