...
public sealed class NocturneOverheadChat : MonoBehaviour
{
    ...
    private static bool On => NocturneConfig.OverheadChat != null && NocturneConfig.OverheadChat.Value;

    private static float Life => NocturneConfig.OverheadChatTime != null ? Mathf.Clamp(NocturneConfig.OverheadChatTime.Value, 2, 15) : 6f;
    ...
    internal void DrawGui()
    {
        ...
        int where = NocturneConfig.OverheadChatWhere != null ? NocturneConfig.OverheadChatWhere.Value : 0;
