...
public sealed class NocturneLobbySettings : MonoBehaviour
{
    ...
    internal static int TaskBar()
    {
        try
        {
            var n = ((Il2CppObjectBase)O).TryCast<NormalGameOptionsV11>();
    ...
    private static T RoleOpt<T>(RoleTypes r) where T : Il2CppObjectBase
    {
        try
        {
            var col = ((Il2CppObjectBase)O.RoleOptions).TryCast<RoleOptionsCollectionV11>();
    ...
    internal static float SciCd() { var o = RoleOpt<ScientistRoleOptionsV11>(RoleTypes.Scientist); return o != null ? o.ScientistCooldown : 0f; }
    internal static void SetSciCd(float v) { var o = RoleOpt<ScientistRoleOptionsV11>(RoleTypes.Scientist); if (o != null) { o.ScientistCooldown = v; Touch(); } }
    internal static float SciBat() { var o = RoleOpt<ScientistRoleOptionsV11>(RoleTypes.Scientist); return o != null ? o.ScientistBatteryCharge : 0f; }
    internal static void SetSciBat(float v) { var o = RoleOpt<ScientistRoleOptionsV11>(RoleTypes.Scientist); if (o != null) { o.ScientistBatteryCharge = v; Touch(); } }

    internal static float EngCd() { var o = RoleOpt<EngineerRoleOptionsV11>(RoleTypes.Engineer); return o != null ? o.EngineerCooldown : 0f; }
    internal static void SetEngCd(float v) { var o = RoleOpt<EngineerRoleOptionsV11>(RoleTypes.Engineer); if (o != null) { o.EngineerCooldown = v; Touch(); } }
    internal static float EngVent() { var o = RoleOpt<EngineerRoleOptionsV11>(RoleTypes.Engineer); return o != null ? o.EngineerInVentMaxTime : 0f; }
    internal static void SetEngVent(float v) { var o = RoleOpt<EngineerRoleOptionsV11>(RoleTypes.Engineer); if (o != null) { o.EngineerInVentMaxTime = v; Touch(); } }

    internal static float GaCd() { var o = RoleOpt<GuardianAngelRoleOptionsV11>(RoleTypes.GuardianAngel); return o != null ? o.GuardianAngelCooldown : 0f; }
    internal static void SetGaCd(float v) { var o = RoleOpt<GuardianAngelRoleOptionsV11>(RoleTypes.GuardianAngel); if (o != null) { o.GuardianAngelCooldown = v; Touch(); } }
    internal static float GaDur() { var o = RoleOpt<GuardianAngelRoleOptionsV11>(RoleTypes.GuardianAngel); return o != null ? o.ProtectionDurationSeconds : 0f; }
    internal static void SetGaDur(float v) { var o = RoleOpt<GuardianAngelRoleOptionsV11>(RoleTypes.GuardianAngel); if (o != null) { o.ProtectionDurationSeconds = v; Touch(); } }
    internal static bool GaImpSee() { var o = RoleOpt<GuardianAngelRoleOptionsV11>(RoleTypes.GuardianAngel); return o != null && o.ImpostorsCanSeeProtect; }
    internal static void SetGaImpSee(bool v) { var o = RoleOpt<GuardianAngelRoleOptionsV11>(RoleTypes.GuardianAngel); if (o != null) { o.ImpostorsCanSeeProtect = v; Touch(); } }

    internal static float TrCd() { var o = RoleOpt<TrackerRoleOptionsV11>(RoleTypes.Tracker); return o != null ? o.TrackerCooldown : 0f; }
    internal static void SetTrCd(float v) { var o = RoleOpt<TrackerRoleOptionsV11>(RoleTypes.Tracker); if (o != null) { o.TrackerCooldown = v; Touch(); } }
    internal static float TrDur() { var o = RoleOpt<TrackerRoleOptionsV11>(RoleTypes.Tracker); return o != null ? o.TrackerDuration : 0f; }
    internal static void SetTrDur(float v) { var o = RoleOpt<TrackerRoleOptionsV11>(RoleTypes.Tracker); if (o != null) { o.TrackerDuration = v; Touch(); } }
    internal static float TrDelay() { var o = RoleOpt<TrackerRoleOptionsV11>(RoleTypes.Tracker); return o != null ? o.TrackerDelay : 0f; }
    internal static void SetTrDelay(float v) { var o = RoleOpt<TrackerRoleOptionsV11>(RoleTypes.Tracker); if (o != null) { o.TrackerDelay = v; Touch(); } }

    internal static float NmDur() { var o = RoleOpt<NoisemakerRoleOptionsV11>(RoleTypes.Noisemaker); return o != null ? o.NoisemakerAlertDuration : 0f; }
    internal static void SetNmDur(float v) { var o = RoleOpt<NoisemakerRoleOptionsV11>(RoleTypes.Noisemaker); if (o != null) { o.NoisemakerAlertDuration = v; Touch(); } }
    internal static bool NmImpAlert() { var o = RoleOpt<NoisemakerRoleOptionsV11>(RoleTypes.Noisemaker); return o != null && o.NoisemakerImpostorAlert; }
    internal static void SetNmImpAlert(bool v) { var o = RoleOpt<NoisemakerRoleOptionsV11>(RoleTypes.Noisemaker); if (o != null) { o.NoisemakerImpostorAlert = v; Touch(); } }

    internal static float DetLimit() { var o = RoleOpt<DetectiveRoleOptionsV11>(RoleTypes.Detective); return o != null ? o.DetectiveSuspectLimit : 0f; }
    internal static void SetDetLimit(float v) { var o = RoleOpt<DetectiveRoleOptionsV11>(RoleTypes.Detective); if (o != null) { o.DetectiveSuspectLimit = v; Touch(); } }

    internal static float SsCd() { var o = RoleOpt<ShapeshifterRoleOptionsV11>(RoleTypes.Shapeshifter); return o != null ? o.ShapeshifterCooldown : 0f; }
    internal static void SetSsCd(float v) { var o = RoleOpt<ShapeshifterRoleOptionsV11>(RoleTypes.Shapeshifter); if (o != null) { o.ShapeshifterCooldown = v; Touch(); } }
    internal static float SsDur() { var o = RoleOpt<ShapeshifterRoleOptionsV11>(RoleTypes.Shapeshifter); return o != null ? o.ShapeshifterDuration : 0f; }
    internal static void SetSsDur(float v) { var o = RoleOpt<ShapeshifterRoleOptionsV11>(RoleTypes.Shapeshifter); if (o != null) { o.ShapeshifterDuration = v; Touch(); } }
    internal static bool SsSkin() { var o = RoleOpt<ShapeshifterRoleOptionsV11>(RoleTypes.Shapeshifter); return o != null && o.ShapeshifterLeaveSkin; }
    internal static void SetSsSkin(bool v) { var o = RoleOpt<ShapeshifterRoleOptionsV11>(RoleTypes.Shapeshifter); if (o != null) { o.ShapeshifterLeaveSkin = v; Touch(); } }

    internal static float PhCd() { var o = RoleOpt<PhantomRoleOptionsV11>(RoleTypes.Phantom); return o != null ? o.PhantomCooldown : 0f; }
    internal static void SetPhCd(float v) { var o = RoleOpt<PhantomRoleOptionsV11>(RoleTypes.Phantom); if (o != null) { o.PhantomCooldown = v; Touch(); } }
    internal static float PhDur() { var o = RoleOpt<PhantomRoleOptionsV11>(RoleTypes.Phantom); return o != null ? o.PhantomDuration : 0f; }
    internal static void SetPhDur(float v) { var o = RoleOpt<PhantomRoleOptionsV11>(RoleTypes.Phantom); if (o != null) { o.PhantomDuration = v; Touch(); } }

    internal static float VpDis() { var o = RoleOpt<ViperRoleOptionsV11>(RoleTypes.Viper); return o != null ? o.ViperDissolveTime : 0f; }
    internal static void SetVpDis(float v) { var o = RoleOpt<ViperRoleOptionsV11>(RoleTypes.Viper); if (o != null) { o.ViperDissolveTime = v; Touch(); } }

    internal static float JudgeTaskPct() { var o = RoleOpt<JudgeRoleOptionsV11>(RoleTypes.Judge); return o != null ? o.JudgeTaskRequirementPercentage : 0f; }
    internal static void SetJudgeTaskPct(float v) { var o = RoleOpt<JudgeRoleOptionsV11>(RoleTypes.Judge); if (o != null) { o.JudgeTaskRequirementPercentage = Mathf.RoundToInt(v); Touch(); } }
