...
internal static class NocturneNav
{
    ...
    private static int Mask
    {
        get
        {
            try
            {
                return LayerMask.GetMask(new[] { "Ship", "Objects" });
            }
            catch
            {
                return 1;
    ...
    private static string Res(int map)
    {
        ...
        {
            case 0:
                return "Nocturne.grid.skeld_onx.json";
            case 1:
                return "Nocturne.grid.mira_onx.json";
            case 2:
                return "Nocturne.grid.polus_onx.json";
            case 3:
                return "Nocturne.grid.skeld_onx.json";
            case 4:
                return "Nocturne.grid.airship_onx.json";
            case 5:
                return "Nocturne.grid.fungle_onx.json";
            default:
                return null;
        }
    }
    ...
    internal static Graph Current()
    {
        ...
        {
            NocturnePlugin.Logger?.LogWarning((object)("Nav load failed: " + e.Message));
            _g = null;
        }
        return _g;
    }
