...
internal static class NocturneHostOptions
{
    ...
    private static bool Loose => NocturneConfig.LooseHostOptions != null && NocturneConfig.LooseHostOptions.Value;
    private static bool MinStep => NocturneConfig.ForceMinValues != null && NocturneConfig.ForceMinValues.Value;
    private static bool FourImp => NocturneConfig.FourImpostors != null && NocturneConfig.FourImpostors.Value;
