...
internal static class NocturneFollow
{
    ...
    internal static void Tick()
    {
        ...
        if (me == null || me.Data == null || me.MyPhysics == null || me.MyPhysics.body == null)
        {
            _target = 255;
            return;
        }
        if ((ShipStatus.Instance == null && LobbyBehaviour.Instance == null) || MeetingHud.Instance != null || me.inVent || !me.CanMove)
            return;
