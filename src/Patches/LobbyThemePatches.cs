...
internal static class NocturneLobbyTheme
{
    ...
    private static void PaintStartButton(PassiveButton b)
    {
        ...
        foreach (ButtonRolloverHandler ro in ((Component)b).GetComponentsInChildren<ButtonRolloverHandler>(true))
            if (ro != null)
                Object.Destroy(ro);
        Button btn = ((Component)b).GetComponent<Button>();
        if (btn != null)
            btn.transition = Selectable.Transition.None;

        Color black = new Color(0.02f, 0.021f, 0.025f, 1f);
        ...
        b.disabledTextColor = new Color(0.62f, 0.65f, 0.70f, 0.55f);
    }
    ...
    private static void PaintSprite(SpriteRenderer r, Color col, float alpha = -1f)
    {
        ...
        r.color = new Color(col.r, col.g, col.b, alpha >= 0f ? alpha * spriteOrig[id].a : spriteOrig[id].a);
    }
