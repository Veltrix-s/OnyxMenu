...
public sealed class NocturneRadar : MonoBehaviour
{
    ...
    {
        if (NocturneConfig.Radar == null || !NocturneConfig.Radar.Value) return;
        ...
        float userSc = Mathf.Clamp((NocturneConfig.RadarSize != null ? NocturneConfig.RadarSize.Value : 100) / 100f, 0.6f, 1.8f);
        _sc = userSc * Mathf.Clamp(Screen.height / 1080f, 0.85f, 2.2f);
        _al = Mathf.Clamp((NocturneConfig.RadarOpacity != null ? NocturneConfig.RadarOpacity.Value : 93) / 100f, 0.3f, 1f);
        ...
        bool locked = NocturneConfig.RadarLocked != null && NocturneConfig.RadarLocked.Value;
        ...
        if (e != null)
        {
            ...
            {
                if (NocturneConfig.RadarLocked != null) NocturneConfig.RadarLocked.Value = !locked;
                _drag = false;
                e.Use();
            }
    ...
    {
        if (NocturneConfig.RadarDoors == null || !NocturneConfig.RadarDoors.Value) return false;
        try
        {
