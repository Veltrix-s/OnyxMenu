...
public sealed class NocturneLobbySettings : MonoBehaviour
{
    ...
    internal static void SetMap(int v)
    {
        try
        {
            O.SetByte(ByteOptionNames.MapId, (byte)Mathf.Clamp(v, 0, 5));
            Touch();
        }
        catch { }
    }
    ...
    {
        SetI(Int32OptionNames.KillDistance, Mathf.Clamp(v, 0, 2));
    }
    ...
    {
        var o = RoleOpt<ScientistRoleOptionsV11>(RoleTypes.Scientist);
        return o != null ? o.ScientistCooldown : 0f;
    }
    ...
    {
        var o = RoleOpt<ScientistRoleOptionsV11>(RoleTypes.Scientist);
        return o != null ? o.ScientistBatteryCharge : 0f;
    }
    ...
    {
        var o = RoleOpt<EngineerRoleOptionsV11>(RoleTypes.Engineer);
        return o != null ? o.EngineerCooldown : 0f;
    }
    ...
    {
        var o = RoleOpt<EngineerRoleOptionsV11>(RoleTypes.Engineer);
        return o != null ? o.EngineerInVentMaxTime : 0f;
    }
    ...
    {
        var o = RoleOpt<GuardianAngelRoleOptionsV11>(RoleTypes.GuardianAngel);
        return o != null ? o.GuardianAngelCooldown : 0f;
    }
    ...
    {
        var o = RoleOpt<GuardianAngelRoleOptionsV11>(RoleTypes.GuardianAngel);
        return o != null ? o.ProtectionDurationSeconds : 0f;
    }
    ...
    {
        var o = RoleOpt<GuardianAngelRoleOptionsV11>(RoleTypes.GuardianAngel);
        return o != null && o.ImpostorsCanSeeProtect;
    }
    ...
    {
        var o = RoleOpt<TrackerRoleOptionsV11>(RoleTypes.Tracker);
        return o != null ? o.TrackerCooldown : 0f;
    }
    ...
    {
        var o = RoleOpt<TrackerRoleOptionsV11>(RoleTypes.Tracker);
        return o != null ? o.TrackerDuration : 0f;
    }
    ...
    {
        var o = RoleOpt<TrackerRoleOptionsV11>(RoleTypes.Tracker);
        return o != null ? o.TrackerDelay : 0f;
    }
    ...
    {
        var o = RoleOpt<NoisemakerRoleOptionsV11>(RoleTypes.Noisemaker);
        return o != null ? o.NoisemakerAlertDuration : 0f;
    }
    ...
    {
        var o = RoleOpt<NoisemakerRoleOptionsV11>(RoleTypes.Noisemaker);
        return o != null && o.NoisemakerImpostorAlert;
    }
    ...
    {
        var o = RoleOpt<DetectiveRoleOptionsV11>(RoleTypes.Detective);
        return o != null ? o.DetectiveSuspectLimit : 0f;
    }
    ...
    {
        var o = RoleOpt<ShapeshifterRoleOptionsV11>(RoleTypes.Shapeshifter);
        return o != null ? o.ShapeshifterCooldown : 0f;
    }
    ...
    {
        var o = RoleOpt<ShapeshifterRoleOptionsV11>(RoleTypes.Shapeshifter);
        return o != null ? o.ShapeshifterDuration : 0f;
    }
    ...
    {
        var o = RoleOpt<ShapeshifterRoleOptionsV11>(RoleTypes.Shapeshifter);
        return o != null && o.ShapeshifterLeaveSkin;
    }
    ...
    {
        var o = RoleOpt<PhantomRoleOptionsV11>(RoleTypes.Phantom);
        return o != null ? o.PhantomCooldown : 0f;
    }
    ...
    {
        var o = RoleOpt<PhantomRoleOptionsV11>(RoleTypes.Phantom);
        return o != null ? o.PhantomDuration : 0f;
    }
    ...
    {
        var o = RoleOpt<ViperRoleOptionsV11>(RoleTypes.Viper);
        return o != null ? o.ViperDissolveTime : 0f;
    }
    ...
    {
        var o = RoleOpt<JudgeRoleOptionsV11>(RoleTypes.Judge);
        return o != null ? o.JudgeTaskRequirementPercentage : 0f;
    }
    internal static void SetJudgeTaskPct(float v)
    {
        ...
        if (o != null)
        {
            o.JudgeTaskRequirementPercentage = Mathf.RoundToInt(v);
            Touch();
        }
    }
