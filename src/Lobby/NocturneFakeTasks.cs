...
public sealed class NocturneFakeTasks : MonoBehaviour
{
    ...
    public void Update()
    {
        ...
        bool scanWant = NocturneConfig.FakeScan != null && NocturneConfig.FakeScan.Value;
        if (scanWant != _scan) { Scan(scanWant); _scan = scanWant; }

        bool camsWant = NocturneConfig.FakeCams != null && NocturneConfig.FakeCams.Value && HasCams();
