...
internal static class NocturneFakeMap
{
    ...
    private static void Disable()
    {
        ...
        {
            NocturnePlugin.Logger?.LogWarning((object)$"FakeMap disable failed: {e.Message}");
        }
    ...
    private static void RestoreLobby()
    {
        ...
        {
            NocturnePlugin.Logger?.LogWarning((object)$"FakeMap restore failed: {e.Message}");
        }
    }
