...
public sealed class NocturneJoinDetector : MonoBehaviour
{
    ...
    private static bool DetectOn => NocturneConfig.JoinDetect != null && NocturneConfig.JoinDetect.Value;
    ...
    private static void AnnounceJoin(ClientData client)
    {
        ...
        try
        {
            ...
            if (!self && NocturneConfig.NotifyKnownPlayer != null && NocturneConfig.NotifyKnownPlayer.Value
        ...
        try
        {
            bool showBots = NocturneConfig.ShowBotJoins != null && NocturneConfig.ShowBotJoins.Value;
