...
internal static class HnSSeekers
{
    ...
    private static bool Enabled => NocturneConfig.HideAndSeekTwoSeekers != null && NocturneConfig.HideAndSeekTwoSeekers.Value;

    private static int Count
    {
        get
        {
            int c = NocturneConfig.SeekerCount != null ? NocturneConfig.SeekerCount.Value : 2;
...
internal static class HnSLeadTimePatch
{
    ...
    {
        if (NocturneConfig.SeekerInstantStart != null && NocturneConfig.SeekerInstantStart.Value) __result = 0;
    }
}
