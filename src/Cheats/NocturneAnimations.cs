...
internal static class NocturneAnimations
{
    ...
    internal static void Toggle(NocturneAnim a)
    {
        ...
        if (a == NocturneAnim.ClimbUp)
            _loops.Remove(NocturneAnim.ClimbDown);
        else if (a == NocturneAnim.ClimbDown)
            _loops.Remove(NocturneAnim.ClimbUp);
        _loops[a] = 0f;
        Play(a);
    }
    ...
    internal static void ForceClimb(PlayerAnimations a)
    {
        ...
        try
        {
            if (!a.IsPlayingClimbAnimation())
                a.PlayClimbAnimation(ClimbDownHeld);
        }
        catch { }
    }
    ...
    private static void Play(NocturneAnim a)
    {
        switch (a)
        {
            case NocturneAnim.ClimbUp:
                RawClimb(false);
                break;
            case NocturneAnim.ClimbDown:
                RawClimb(true);
                break;
            case NocturneAnim.EnterVent:
                RawVent(true);
    ...
    internal static void MeetingSting()
    {
        ...
        if (c != null && s != null)
            try
            {
                s.PlaySound(c, false, 0.7f, (AudioMixerGroup)null);
            }
            catch { }
    }
    ...
    internal static void EjectSfx()
    {
        ...
        if (c != null && s != null)
            try
            {
                s.PlaySoundImmediate(c, false, 0.8f, 1f, (AudioMixerGroup)null);
            }
            catch { }
    }
