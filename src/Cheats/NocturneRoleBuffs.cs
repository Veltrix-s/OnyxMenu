...
public sealed class NocturneRoleBuffs : MonoBehaviour
{
    ...
    internal static PlayerControl NearestValid(DetectiveRole role)
    {
        ...
        while (e.MoveNext())
        {
            ...
            if (t == null || t == me || !Alive(t) || t.Data.Disconnected)
                continue;
            if (!role.IsValidTarget(t.Data))
                continue;
    ...
    internal static PlayerControl NearestKill(float max, bool anyone)
    {
        ...
        {
            PlayerControl t = e.Current;
            if (t == null || t == me || !Alive(t) || t.inVent)
                continue;
    ...
    {
        PlayerControl me = PlayerControl.LocalPlayer;
        if (me == null || ShipStatus.Instance == null)
            return;
        ...
        if (NocturneConfig.BuffKillAura.Value)
            Aura(me);
    }

    private void Aura(PlayerControl me)
    {
        if (!Alive(me) || me.inVent || MeetingHud.Instance != null)
            return;
        RoleBehaviour r = me.Data.Role;
        ...
        if (Time.time < auraAt)
            return;
        if (me.killTimer > 0.05f && !(NocturneConfig.BuffNoKillCd.Value && Host()))
            return;
...
internal static class BuffVentUsePatch
{
    ...
    {
        if (!NocturneRoleBuffs.VentAny || !NocturneRoleBuffs.Ventless())
            return;
        PlayerControl me = PlayerControl.LocalPlayer;
        if (pc == null || me == null || pc.PlayerId != me.PlayerId)
            return;
...
internal static class BuffVentMovePatch
{
    public static void Postfix(PlayerControl __instance, ref bool __result)
    {
        ...
        if (__instance.Data == null || __instance.Data.IsDead)
            return;
        if (!NocturneConfig.BuffVentWalk.Value && !BuffVentSabPatch.Opening)
            return;
        __result = true;
    }
}
...
internal static class BuffReachPatch
{
    public static bool Prefix(ref PlayerControl __result)
    {
        ...
        if (!NocturneRoleBuffs.Reach && !any && !ghost)
            return true;
...
internal static class BuffKillCdPatch
{
    public static void Prefix(PlayerControl __instance, ref float __0)
    {
        if (__instance != PlayerControl.LocalPlayer)
            return;
        if (NocturneConfig.BuffNoKillCd.Value && NocturneRoleBuffs.Host())
            __0 = 0f;
    }
}
...
internal static class BuffShiftPatch
{
    ...
    {
        if (!NocturneConfig.BuffSsForever.Value || __instance == null)
            return;
...
internal static class BuffShiftQuietPatch
{
    ...
    {
        if (NocturneConfig.BuffSsQuiet.Value)
            __1 = false;
    }
}
...
internal static class BuffEngPatch
{
    public static void Postfix(EngineerRole __instance)
    {
        if (__instance == null || __instance.Player != PlayerControl.LocalPlayer)
            return;
        if (NocturneConfig.BuffEngVent.Value)
            __instance.inVentTimeRemaining = float.MaxValue;
        if (!NocturneConfig.BuffEngCd.Value || __instance.cooldownSecondsRemaining <= 0f)
            return;
...
internal static class BuffVentSabPatch
{
    ...
    {
        if (!NocturneConfig.BuffVentSab.Value || __instance == null)
            return;
        PlayerControl me = PlayerControl.LocalPlayer;
        if (!NocturneRoleBuffs.Alive(me) || !me.inVent)
            return;
        RoleBehaviour r = me.Data.Role;
        if (r == null || (int)r.TeamType != 1)
            return;
        try
        {
...
internal static class BuffVentSabClickPatch
{
    ...
    {
        if (!NocturneConfig.BuffVentSab.Value)
            return true;
        PlayerControl me = PlayerControl.LocalPlayer;
        if (!NocturneRoleBuffs.Alive(me) || !me.inVent)
            return true;
...
internal static class BuffSciPatch
{
    public static void Postfix(ScientistRole __instance)
    {
        if (__instance == null || __instance.Player != PlayerControl.LocalPlayer)
            return;
        if (NocturneConfig.BuffSciCd.Value)
            __instance.currentCooldown = 0f;
        if (NocturneConfig.BuffSciBat.Value)
...
internal static class BuffDetPatch
{
    ...
    {
        if (!NocturneConfig.BuffDetReach.Value)
            return true;
...
internal static class BuffDetCdPatch
{
    public static void Postfix(DetectiveRole __instance)
    {
        if (__instance == null || __instance.Player != PlayerControl.LocalPlayer)
            return;
        if (!NocturneConfig.BuffDetCd.Value || __instance.cooldownSecondsRemaining <= 0f)
            return;
...
internal static class BuffJudgeTasksPatch
{
    public static void Postfix(JudgeRole __instance, ref bool __result)
    {
        if (!NocturneConfig.BuffJudgeNoTasks.Value || __instance == null)
            return;
        if (__instance.Player != PlayerControl.LocalPlayer)
            return;
        __result = false;
...
internal static class BuffTaskPatch
{
    ...
    {
        if (NocturneConfig.BuffImpTasks.Value && __instance != null)
...
internal static class BuffAutoReportPatch
{
    ...
    {
        if (!NocturneConfig.BuffAutoReport.Value)
            return;
        PlayerControl me = PlayerControl.LocalPlayer;
        if (!NocturneRoleBuffs.Alive(me) || target == null || target.Data == null)
            return;
        try
        {
            me.CmdReportDeadBody(target.Data);
        }
        catch { }
    }
}
