...
public sealed class NocturneEventNotify : MonoBehaviour
{
    ...
    internal static bool On => NocturneConfig.EventNotify != null && NocturneConfig.EventNotify.Value;
    ...
    internal static void Fire(NocturneEventCat cat, string ru, string en, NocturneNotifyKind kind, bool toast)
    {
        ...
        if (NocturneConfig.EventNotifyChat != null && NocturneConfig.EventNotifyChat.Value)
        {
            try
            {
    ...
    public void Update()
    {
        ...
        bool toast = NocturneConfig.NotifySabotage != null && NocturneConfig.NotifySabotage.Value;
    ...
    private static class VkPatch
    {
        public static void Postfix(int __0, int __1)
        {
            ...
            bool toast = NocturneConfig.NotifyVotekick != null && NocturneConfig.NotifyVotekick.Value && !Mine(__0);
    ...
    private static class KillPatch
    {
        public static void Postfix(PlayerControl __instance, PlayerControl target)
        {
            ...
            bool toast = NocturneConfig.NotifyKill != null && NocturneConfig.NotifyKill.Value && !Mine(__instance.OwnerId);
    ...
    private static class MeetPatch
    {
        ...
        {
            bool toast = NocturneConfig.NotifyMeeting != null && NocturneConfig.NotifyMeeting.Value;
    ...
    private static class EjectPatch
    {
        public static void Postfix(ExileController __instance)
        {
            ...
            try
            {
                ...
                bool toast = NocturneConfig.NotifyEject != null && NocturneConfig.NotifyEject.Value;
