...
public sealed class NocturneAutoVent : MonoBehaviour
{
    ...
    private static void Escape()
    {
        ...
        {
            PlayerControl me = PlayerControl.LocalPlayer;
            if (me == null || me.Data == null || me.Data.IsDead || me.MyPhysics == null)
                return;
            if (ShipStatus.Instance == null || MeetingHud.Instance != null || me.inVent)
                return;
...
internal static class NocturneAutoVentKillPatch
{
    public static void Postfix(PlayerControl __instance)
    {
        try
        {
            if (!NocturneAutoVent.On || __instance == null || __instance != PlayerControl.LocalPlayer)
                return;
