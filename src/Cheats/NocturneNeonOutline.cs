...
internal static class NocturneNeonOutline
{
    ...
    private static bool On => NocturneConfig.NeonOutline != null && NocturneConfig.NeonOutline.Value;
    ...
    {
        int mode = NocturneConfig.NeonOutlineMode != null ? NocturneConfig.NeonOutlineMode.Value : 1;
        try
        {
            if (mode == 0)
