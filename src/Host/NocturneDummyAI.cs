...
internal static class NocturneDummyAI
{
    ...
    private static bool Active()
    {
        try
        {
            bool tasks = NocturneConfig.DummyDoTasks != null && NocturneConfig.DummyDoTasks.Value;
            bool fix = NocturneConfig.DummyFixSabotage != null && NocturneConfig.DummyFixSabotage.Value;
