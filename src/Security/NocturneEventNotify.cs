...
public sealed class NocturneEventNotify : MonoBehaviour
{
    ...
    public void Update()
    {
        ...
        for (int i = 0; i < SabSys.Length; i++)
        {
            ...
            if (now && !SabPrev[i])
            {
                ...
                try
                {
                    NocturneReplay.Rec(NocturneReplay.Rt.Sabotage, 255, Vector2.zero, Vector2.zero);
                }
                catch { }
            }
            SabPrev[i] = now;
    ...
    private static class MeetPatch
    {
        public static void Postfix()
        {
            ...
            try
            {
                NocturneReplay.Rec(NocturneReplay.Rt.Meeting, 255, Vector2.zero, Vector2.zero);
            }
            catch { }
        }
    }
    ...
    private static class VentEnterPatch
    {
        public static void Postfix([HarmonyArgument(0)] PlayerControl pc)
        {
            ...
            try
            {
                NocturneReplay.Rec(NocturneReplay.Rt.Vent, pc.PlayerId, pc.GetTruePosition(), Vector2.zero);
            }
            catch { }
        }
    }
    ...
    private static class ShiftPatch
    {
        public static void Postfix(PlayerControl __instance, [HarmonyArgument(0)] PlayerControl target)
        {
            ...
            try
            {
                NocturneReplay.Rec(NocturneReplay.Rt.Shift, __instance.PlayerId, __instance.GetTruePosition(), Vector2.zero);
            }
            catch { }
        }
    }
    ...
    private static class ProtectPatch
    {
        public static void Postfix(PlayerControl __instance, [HarmonyArgument(0)] PlayerControl target)
        {
            ...
            try
            {
                NocturneReplay.Rec(NocturneReplay.Rt.Protect, __instance.PlayerId, __instance.GetTruePosition(), Vector2.zero);
            }
            catch { }
        }
    }
    ...
    private static class ReportPatch
    {
        public static void Postfix(PlayerControl __instance, [HarmonyArgument(0)] NetworkedPlayerInfo target)
        {
            ...
            try
            {
                NocturneReplay.Rec(NocturneReplay.Rt.Report, __instance.PlayerId, __instance.GetTruePosition(), Vector2.zero);
            }
            catch { }
        }
    }
